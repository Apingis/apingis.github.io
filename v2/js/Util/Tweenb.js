...
if (time === this._lastUpdateT) {

	if (this._lastUpdateCnt ++ > 50) {
		//console.error(`TWEEN.update looped`);
		//throw "update_hangs";
		return false;
	}
	...
	this._lastUpdateT = time;
	this._lastUpdateCnt = 0;
}

// hangs			while (tweenIds.length > 0) {
			for (let i1 = 0; i1 < 1e4; i1++) {
...
TWEEN.Tween = function (object) {
	...
	this._onBeforeUpdateCallback = null;
...
TWEEN.Tween.prototype = assign(Object.create(Object.prototype), {
	...
	onBeforeUpdate: function onBeforeUpdate(callback) {
...
TWEEN.Easing = {
	...
	Custom1: function (k) {
		...
		return 0.5 * (- Math.pow(2, - 10 * (2 * k - 1)) + 2);
